...
global.dfail = (type, m, conn) => {
  let msg = {
    owner: 'Este Comando So pode ser usado Pelo propietario do bot!',
    mods: 'Este Comando so pode ser usado por Adms!',
    premium: 'Este comando é apenas para membros!',
    group: 'Este comando só pode ser usado em grupos!',
    private: 'Este comando só pode ser usado em Chats Privados!',
    admin: 'Você Nao e um adm do grupo.!',
    botAdmin: 'Para Usar esse comando o bot precisa de Adm No grupo!'
  }[type]
